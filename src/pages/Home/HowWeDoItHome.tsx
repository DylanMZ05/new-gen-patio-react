...
const HowWeDoItHome: React.FC = () => {
    ...
    return (
        <section id="our-promise" className="flex flex-col items-center justfy-center py-[50px] px-[25px] border-t-1 border-t-black/20">
            ...
            <Link to='/howwedoit' className="text-white bg-black text-xl font-semibold px-5 pt-1 pb-2 rounded-4xl mt-5 transition-all hover:bg-black/90 hover:scale-102"
