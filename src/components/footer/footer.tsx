...
const Footer: React.FC = () => {
    return (
        <footer className="background-skyblue flex items-center justify-center">
            <section id='contacto' className="background-skyblue w-screen max-w-[1400px] flex-col align-center flex justify-center py-10 md:flex-row md:justify-between md:items-start md:px-10">
