...
const WhyUsLink = () => {
  ...
  return (
    <div className='relative w-full flex flex-col items-center justify-center bg-cover bg-center bg-fixed' style={{ backgroundImage: "url('assets/images/Free3.jpg')" }}>
      <div id="our-promise" className="w-full bg-black/60 py-[50px] px-[25px]">

        <h2 className="font-semibold text-4xl text-white">Why Us?</h2>
