...
const FinancingOptions: React.FC = () => {
    return (
        <section className="flex flex-col items-center justify-center text-center p-6 h-screen">
            ...
            <img
                src="/assets/logo.png" // Reemplaza con la ruta real de tu logo
            ...
            <div className="flex gap-6">
                ...
                >
                    <img
                        src="/assets/vistafi.png" // Reemplaza con la ruta real
                ...
                >
                    <img
                        src="/assets/hearth.png" // Reemplaza con la ruta real
